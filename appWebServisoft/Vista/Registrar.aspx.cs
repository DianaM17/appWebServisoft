...
namespace appWebServisoft.Vista
{
    public partial class Registrar : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            BtnRegistrarProfesional.ServerClick += new EventHandler(BtnRegistrarProfesional_ServerClick);
        }
        protected void RegistroCliente_ServerClick(object sender, EventArgs e)
        {
